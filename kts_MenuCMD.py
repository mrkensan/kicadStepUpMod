...
class ktsPullPcbOutline:
    "Pull outlines from KiCAD PCB layer into Sketch object"
 
    def GetResources(self):
        from kts_locator import kts_mod_path_to_icon

        return {'Pixmap'  : kts_mod_path_to_icon('Sketcher_Pull.svg') , # the name of a svg file available in the resources
...
FreeCADGui.addCommand('ktsPullPcbOutline',ktsPullPcbOutline())
# END Command - ktsPullPcbOutline